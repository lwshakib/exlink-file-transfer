...
// 'Default' brand theme (Monochrome/Black & White). The main default visual style.
const Default = {
  name: 'Default',
  light: {
    ...baseLight,
    ...
    elevation: {
      ...
      level3: 'rgb(224, 224, 224)',
      level4: 'rgb(224, 224, 224)',
      level5: 'rgb(215, 215, 215)',
    },
  },
  dark: {
    ...baseDark,
    ...
    onSecondaryContainer: 'rgb(224, 224, 224)',
...
export const ThemeVariations = [Default, Emerald, Violet, Blue, Amber, Rose];

// Expose the primary 'Default' configuration as the fallback/default 'Colors'.
